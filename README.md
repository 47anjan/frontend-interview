...
_Why:_ Fastest reference for syntax and attributes.  
_How to Use:_
...
_Why:_ Modern best practices, Core Web Vitals integration.  
_How to Use:_
...
_Why:_ Visual diagrams for mental models.  
_How to Use:_
...
_Why:_ Best structured tutorial—from basics to advanced (event loop, microtasks).  
_How to Use:_
...
_Why:_ Visual explanations of closures, hoisting, `this`, prototypes.  
_How to Use:_
...
_Why:_ Deep dives into coercion, scope, `this`, prototypes, async.  
_How to Use:_
...
_Why:_ Hands-on JavaScript problems, polyfills, and frontend interview questions.  
_How to Use:_
...
_Why:_ New docs with interactive examples and mental models (e.g., "UI as a function of state").  
_How to Use:_
...
_Why:_ Advanced patterns, performance optimization, anti-patterns.  
_How to Use:_
...
_Why:_ Practical tutorials on TypeScript + React, state management, microfrontends.  
_How to Use:_
...
_Why:_ Test user behavior, not implementation details.  
_How to Use:_
...
_Why:_ Modern web app patterns for React, performance, rendering, and design patterns—created by Addy Osmani and Lydia Hallie.  
_How to Use:_
...
_Why:_ Classic Gang of Four patterns adapted for JavaScript—Singleton, Factory, Observer, Module, etc.  
_How to Use:_
...
_Why:_ Collection of React-specific patterns with code examples.  
_How to Use:_
...
_Why:_ Comprehensive collection of JavaScript patterns with explanations.  
_How to Use:_
...
_Why:_ Visual explanations of design patterns with examples in multiple languages including JavaScript.  
_How to Use:_
...
_Why:_ NeetCode organizes problems by pattern with video explanations.  
_How to Use:_
...
_Why:_ Animated visualizations of sorting, trees, graphs.  
_How to Use:_
...
_Why:_ Complete graph algorithms tutorial covering all patterns needed for interviews—DFS, BFS, shortest path, islands, etc.  
_How to Use:_
...
_Why:_ Comprehensive DP tutorial explaining memoization, tabulation, and pattern recognition—one of the best DP explanations available.  
_How to Use:_
...
_Why:_ Frontend-specific frameworks (not backend-focused).  
_How to Use:_
...
_Why:_ Newsletter and articles on frontend architecture, scaling, and design patterns by Maxi Ferreira (Staff Engineer at Google Chrome).  
_How to Use:_
...
_Why:_ Walkthrough of Uber, Netflix, Twitter UI designs.  
_How to Use:_
...
_Why:_ Comprehensive playlist covering frontend system design concepts, architecture, and real-world examples.  
_How to Use:_
...
_Why:_ Curated list of real-world case studies from companies like Airbnb, Netflix, Spotify, Uber, and major tech companies showing how they built and scaled their frontends.  
_How to Use:_
...
_Why:_ Industry standard for unit tests.  
_How to Use:_
...
_Why:_ Tests resemble how users interact with your app.  
_How to Use:_
...
_Why:_ E2E tests for critical flows (login, checkout).  
_How to Use:_
...
_Why:_ Checklists, contrast checker, articles.  
_How to Use:_
...
_Why:_ Technical reference for ARIA roles, states, properties.  
_How to Use:_
...
_Why:_ Guides on every optimization technique.  
_How to Use:_
...
_Why:_ Visualize what's in your bundle.  
_How to Use:_
...
_Why:_ Next-generation build tool—lightning-fast HMR, native ES modules, and optimized production builds.  
_How to Use:_
...
_Why:_ React framework with SSR, ISR, file-based routing, and API routes built-in.  
_How to Use:_
...
_Why:_ Type safety catches bugs at compile time and improves developer experience with autocomplete.  
_How to Use:_
...
_Why:_ Catch code quality issues, bugs, and enforce consistent style across teams.  
_How to Use:_
...
_Why:_ Opinionated code formatter—stops style debates and saves time in code reviews.  
_How to Use:_
...
_Why:_ Automate CI/CD pipelines—tests, builds, deployments, and quality checks.  
_How to Use:_
...
_Why:_ Develop and document UI components in isolation—improves component reusability and team collaboration.  
_How to Use:_
...
_Why:_ Still widely used—understanding module bundlers helps with debugging and optimization.  
_How to Use:_
...
_Why:_ Vite-native testing framework—instant test execution with HMR.  
_How to Use:_
...
_Why:_ Next-generation bundler built in Rust—successor to Webpack, incrementally adopted by Next.js.  
_How to Use:_
...
_Why:_ Real machine coding questions asked at top companies (Google, Meta, Amazon).  
_How to Use:_
...
_Why:_ JavaScript coding challenges and React component questions.  
_How to Use:_
...
_Why:_ Timed challenges mimicking real interview conditions.  
_How to Use:_
...
_Why:_ Practice frontend machine coding with real interview-style problems—covers HTML/CSS, JavaScript, and React.  
_How to Use:_
...
_Why:_ Collection of commonly asked frontend interview coding problems with solutions explained.  
_How to Use:_
...
_Why:_ 30 vanilla JavaScript projects in 30 days—builds muscle memory for DOM manipulation and browser APIs.  
_How to Use:_
...
_Why:_ Real-world UI challenges with professional designs—practice building pixel-perfect components.  
_How to Use:_
...
_Why:_ Weekly interview questions (algorithms + frontend challenges) from a senior engineer.  
_How to Use:_
...
_Why:_ AI pair programmer—suggests code, completes functions, generates tests.  
_How to Use:_
...
_Why:_ AI-first code editor—built-in chat, codebase-aware AI, multi-file edits.  
_How to Use:_
...
_Why:_ Generate UI components from text prompts—outputs React/Tailwind/Shadcn code.  
_How to Use:_
...
_Why:_ General-purpose AI for debugging, learning, code review, and technical writing.  
_How to Use:_
...
_Why:_ AI search engine for developers—answers coding questions with sources.  
_How to Use:_
...
_Why:_ Framework-agnostic toolkit for building AI-powered streaming UIs with React, Vue, Svelte.  
_How to Use:_
...
_Why:_ JavaScript framework for building LLM-powered applications—chains, agents, memory.  
_How to Use:_
...
_Why:_ Direct access to GPT models—text generation, embeddings, image generation (DALL-E).  
_How to Use:_
...
_Why:_ Alternative to OpenAI with larger context window (100K+ tokens)—great for long documents.  
_How to Use:_
...
_Why:_ Run machine learning models directly in the browser with WebAssembly—no backend needed!  
_How to Use:_
...
_Why:_ AI-powered research tool with cited sources—better than ChatGPT for factual information.  
_How to Use:_
...
_Why:_ Free alternative to GitHub Copilot—code completion, chat, multi-language support.  
_How to Use:_
...
_Why:_ AI code completion trained on open-source code—works offline, privacy-focused.  
_How to Use:_
...
_Why:_ AI coding assistant from AWS—optimized for AWS services but works for general code.  
_How to Use:_
...
_Why:_ Comprehensive guide to prompt engineering—essential skill for working with AI.  
_How to Use:_
...
_Why:_ Official guide from OpenAI—best practices for getting good results.  
_How to Use:_
